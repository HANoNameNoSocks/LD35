...
preload.prototype = {
	preload: function(){ 
		...
		this.game.load.image('waterdead','assets/img/waterdead.png');
 	 	this.game.load.spritesheet('sprFire', 'assets/img/fireSprite.png', 39,40,16);
 	 	this.game.load.spritesheet('ennemyPlant', 'assets/img/ennemyPlant.png', 110,115,9);
 	 	this.game.load.spritesheet('sprWater', 'assets/img/waterSprite.png', 39,40,16);

 	 	this.game.load.spritesheet('sprAttaqueFire', 'assets/img/heroAttaqueFire.png', 39,40,16);
 	 	//this.game.load.spritesheet('sprAttaqurPlant', 'assets/img/heroAttaquePlant.png', 110,115,10);
 	 	this.game.load.spritesheet('sprAttaqueWater', 'assets/img/heroAttaqueWater.png', 39,40,16);


		this.game.load.image("hero", "assets/img/hero.png", 39,40,16);
